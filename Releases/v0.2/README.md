...
Chrome Web Store release assets for DeSpoilerize v0.2.0.

## Package

- [despoilerize-v0.2.0-chrome-web-store.zip](./despoilerize-v0.2.0-chrome-web-store.zip)
...
- [Sports pack settings](./screenshots/03-sports-pack-settings.png)
